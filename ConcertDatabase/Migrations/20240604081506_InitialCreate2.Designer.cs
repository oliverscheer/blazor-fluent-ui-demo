...
namespace ConcertDatabase.Migrations
{
    ...
    [Migration("20240604081506_InitialCreate2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConcertDatabase.Models.Artist", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ConcertDatabase.Models.Concert", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ConcertDatabase.Models.Concert", b =>
                {
                    b.HasOne("ConcertDatabase.Models.Artist", "Artist")
                        .WithMany("Concerts")
